...
$string['introtext'] = "This is a tool for generating custom CSS for the Moodle Mobile app, especially overriding " .
        "the default colors. It will guide you through three simple steps:";
$string['introstep1'] = "1. Download the latest Moodle Mobile default CSS.";
$string['introstep2'] = "2. View the latest default CSS's color scheme and pick out any alternate colors " .
        "you prefer, plus add any extra custom CSS.";
$string['introstep3'] = "3. Generate a custom CSS file to override the default colors and add your extra custom CSS, " .
...
$string['colorformdesc'] = 'Choose alternate colors for any default colors you would like to replace. If you don\'t ' .
        ...
        'mobile CSS.';
$string['colorformcalltoaction'] = 'When you\'re done, click the one of the "Generate custom CSS" buttons at the top ' .
        'and bottom of the page! Generating your CSS may take a moment.';
